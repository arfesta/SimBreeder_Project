...
#### Create 1st gen progeny#######
  ...
  progeny1.extractions <- extract.selections(crossdesign = cross.design, parentinfo = OP.parent.phenos, past.tgv = parents.TGV,past.phenos = parents.phenos,
                                             progenyinfo = progeny1,progenyTGV = progeny1.TGV,progenyphenos = progeny1.phenos,selection.strategy = "within.family",
                                             among.family.selection = "ABLUP", within.family.selection = "NO", reduced = T,numSelections.among.family = 64)
...
####Generation 2#####
  ...
  progeny2.extractions <- extract.selections(crossdesign=cross.design, past.tgv = progeny1.TGV,
                                             ...
                                             among.family.selection = "ABLUP",within.family.selection = "NO",numSelections.among.family = 64)
...
####Generations 3####
  ...
  progeny3.extractions <- extract.selections(crossdesign=cross.design, past.tgv = progeny2.TGV,
...
####Generation 4####
  ...
  progeny4.extractions <- extract.selections(crossdesign=cross.design,
...
####Generation 5####
  ...
  progeny5.extractions <- extract.selections(crossdesign=cross.design,
...
####Generation 6####
  ...
  progeny6.extractions <- extract.selections(crossdesign=cross.design,
...
####Generation 7####
  ...
  progeny7.extractions <- extract.selections(crossdesign=cross.design,
...
####Generation 8####
  ...
  progeny8.extractions <- extract.selections(crossdesign=cross.design,
...
####Generation 9####
  ...
  progeny9.extractions <- extract.selections(crossdesign=cross.design,
...
####Generation 10####
  ...
  progeny10.extractions <- extract.selections(crossdesign=cross.design,
