...
mclapply(1:30,function(pop.num){ # Change 118:300 to 1:30 
  ...
  the.name <- paste("GBLUP.nodom.64.pop_", pop.num, sep="")
  ...
  save(newList,file=paste("/media/hd02/Rsimulations/SimBreeder_Project/results/64/GBLUP_NoClust/",the.name,".RData",sep="")) # Change path
